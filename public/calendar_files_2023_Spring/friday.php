    ...
    <main>
      ...
      <div class="screenings-list">
        ...
        <div class="screening">
          ...
          <img src="/images/2023spring/harold-and-maude-1971.jpg" alt="Harold and Maude (1971) still">
          ...
          <h2>7:00PM Friday, September 29th</h2>
        </div>
        
        <div class="screening">
          <h2>Lost Highway (1997)</h2>
          <img src="/images/2023spring/lost-highway-1997.jpg" alt="Lost Highway (1997) still">
          ...
          <h2>7:00PM Friday, October 6th</h2>
        </div>
        
        <div class="screening">
          <h2>A Woman Under the Influence (1974)</h2>
          <img src="/images/2023spring/a-woman-under-the-influence-1974.jpg" alt="A Woman Under the Influence (1974) still">
          ...
          <h2>7:00PM Friday, October 13th&middot; 4:00PM Saturday, October 14th</h2>
        </div>
        
        <div class="screening">
          <h2>Badlands (1973)</h2>
          <img src="/images/2023spring/badlands-1973.jpg" alt="Badlands (1973) still">
          ...
          <h2>7:00PM Friday, October 20th&middot; 3:00PM Sunday, October 22nd</h2>
        </div>
        
        <div class="screening">
          <h2>Thirst (2009)</h2>
          <img src="/images/2023spring/thirst-2009.jpg" alt="Thirst (2009) still">
          ...
          <h2>7:00PM Friday, October 27th</h2>
        </div>
        
        <div class="screening">
          <h2>A Story from Chikamatsu (1954)</h2>
          <img src="/images/2023spring/a-story-from-chikamatsu-1954.jpg" alt="A Story from Chikamatsu (1954) still">
          ...
          <h2>7:00PM Friday, November 3rd</h2>
        </div>
        
        <div class="screening">
          <h2>Gun Crazy (1950)</h2>
          <img src="/images/2023spring/gun-crazy-1950.jpg" alt="Gun Crazy (1950) still">
          ...
          <h2>7:00PM Friday, November 10th&middot; 7:00PM Saturday, November 11th</h2>
        </div>
        
        <div class="screening">
          <h2>The Night Porter (1974)</h2>
          <img src="/images/2023spring/the-night-porter-1974.jpg" alt="The Night Porter (1974) still">
          ...
          <h2>7:00PM Friday, November 17th</h2>
        </div>
        
        <div class="screening">
          <h2>Written on the Wind (1956)</h2>
          <img src="/images/2023spring/written-on-the-wind-1956.jpg" alt="Written on the Wind (1956) still">
          ...
          <h2>7:00PM Friday, December 1st</h2>
        </div>
