    ...
    <main>
      ...
      <div class="screenings-list">
        ...
        <div class="text-section">
          <h1>SUNDAY - The Decisive Moment: Photographers Turned Filmmakers</h1>
          <h3>Programmed by: Ian Resnick</h3>

            <p>Eadweard Muybridge’s <i>The Horse in Motion</i> (1878), a series of 12 cabinet cards depicting the gallop of a horse, was the first documented example of chronography—a technique used to capture the passage of time through a series of rapidly alternating photographs. The cabinet cards could be viewed through a zoetrope to render the illusion of motion. <i>The Horse in Motion</i> is considered to be the first “motion picture,” showing that filmmaking is quite literally born out of the medium of still photography. One can step into the Doc Films projection booth and still see proof of this fact; peer down at a 35mm print stretched out on the light table, and you will see frame after individual frame, 1/24th of a second of your favorite films frozen in time.</p>

            <p>The histories of filmmaking and photography run parallel. Both struggled to acquire recognition as artistic mediums, relegated to labels of scientific tool or popular entertainment. This series seeks to shed light on the intersections of cinematic and photographic history—their shared figures, theories, and techniques. Here are presented works from filmmakers who began their careers as professional or amateur still photographers. The films presented span the 20th century, and reflect the photographic sensibilities of their directors: the pioneering modernist photography of Paul Strand and Willard Van Dyke, Robert Frank’s intimate documentations of American life, Gordon Parks’ civil rights photo-journalism, Spike Jonze’s BMX and skate videos. These works highlight the preoccupations of the wandering photographer, the concern with historical documentation, the visual spontaneity, the attunement to gesture, shape, and space. </p>
        </div>
        
        <div class="screening">
          <h2>Manhatta (1921) // The City (1939)</h2>
          <img src="/images/2023spring/manhatta-1921.jpg" alt="Manhatta (1921) // The City (1939) still">
          ...
          <h2>8:00PM Sunday, March 26th</h2>
        </div>
        ...
        <div class="screening">
          ...
          <img src="/images/2023spring/pull-my-daisy-1959.jpg" alt="Pull My Daisy (1959) // Me and My Brother (1969) still">
          ...
          <h2>7:00PM Sunday, April 30th</h2>
        </div>
        ...
        <div class="screening">
          ...
          <img src="/images/2023spring/born-to-film-1982.jpg" alt="Born to Film (1982) // Los niños abandonados (1975) still">
          <h3>Danny Lyon // Danny Lyon &middot; 33m // 63m &middot; DCP</h3>
