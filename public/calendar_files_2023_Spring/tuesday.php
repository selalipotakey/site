    ...
    <main>
      ...
      <div class="screenings-list">
        ...
        <div class="text-section">
          <h1>TUESDAY - False Preachers</h1>
          <h3>Programmed by: Hannah O.</h3>

            <p>In the opening sequence of <i>The Night of the Hunter</i>, Lillian Gish reads from the Gospel of Matthew as children’s faces shine like stars against the night sky: “Beware of false prophets which come to you in sheep’s clothing; but inwardly they are ravening wolves.” Taken from Jesus’s Sermon on the Mount, the text goes on to provide another metaphor for identifying false prophets: “A good tree cannot bring forth evil fruit, neither can a corrupt tree bring forth good fruit ... Wherefore by their fruits ye shall know them.” TAB This series explores the trope of the false prophet in American film, ranging from the cartoonish wickedness of Reverend Harry Powell in <i>The Night of the Hunter</i>, to the delirious atheism of Hazel Motes and sham piety of Asa Hawks in <i>Wise Blood</i>, to the tragic big-heartedness of Sonny in <i>The Apostle</i>. These films provide a window into the entanglement of money, morality, and ecstatic faith that characterizes the American religious landscape. Conscience threatens to dampen charisma as many of these preachers grapple with their sins and struggle to justify their double lives. Glimpses of sincerity shine through otherwise cynical stories of hucksters looking to line their pockets. Divine revelation overpowers human weakness, egotism, and duplicity. Blindness—both physical and figurative—appears as a motif in several of these films, suggesting that the eyes cannot always be trusted: not by sight, but “by their fruits ye shall know them.”</p>
            
            <p><b>Hannah Ozmun

Supported by The Martin Marty Center at the University of Chicago Divinity School.</b></p>
        </div>
        
        <div class="screening">
          <h2>The Night of the Hunter (1955)</h2>
          <img src="/images/2023spring/the-night-of-the-hunter-1955.jpg" alt="The Night of the Hunter (1955) still">
          ...
          <h2>7:00PM Tuesday, September 26th&middot</h2>
        </div>
        
        <div class="screening">
          <h2>Salesman (1969)</h2>
          <img src="/images/2023spring/salesman-1969.jpg" alt="Salesman (1969) still">
          ...
          <h2>7:00PM Tuesday, October 3rd&middot</h2>
        </div>
        
        <div class="screening">
          <h2>Wise Blood (1979)</h2>
          <img src="/images/2023spring/wise-blood-1979.jpg" alt="Wise Blood (1979) still">
          ...
          <h2>7:00PM Tuesday, October 10th&middot</h2>
        </div>
        
        <div class="screening">
          <h2>Body and Soul (1925)</h2>
          <img src="/images/2023spring/body-and-soul-1925.jpg" alt="Body and Soul (1925) still">
          ...
          <h2>7:00PM Tuesday, October 17th&middot</h2>
        </div>
        
        <div class="screening">
          <h2>Marjoe (1972)</h2>
          <img src="/images/2023spring/marjoe-1972.jpg" alt="Marjoe (1972) still">
          ...
          <h2>7:00PM Tuesday, October 24th&middot</h2>
        </div>
        
        <div class="screening">
          <h2>Buck and the Preacher (1972)</h2>
          <img src="/images/2023spring/buck-and-the-preacher-1972.jpg" alt="Buck and the Preacher (1972) still">
          ...
          <h2>7:00PM Tuesday, October 31st&middot</h2>
        </div>
        
        <div class="screening">
          <h2>The Miracle Woman (1931)</h2>
          <img src="/images/2023spring/the-miracle-woman-1931.jpg" alt="The Miracle Woman (1931) still">
          ...
          <h2>7:00PM Tuesday, November 7th&middot</h2>
        </div>
        
        <div class="screening">
          <h2>The Night of the Iguana (1964)</h2>
          <img src="/images/2023spring/the-night-of-the-iguana-1964.jpg" alt="The Night of the Iguana (1964) still">
          ...
          <h2>7:00PM Tuesday, November 14th&middot</h2>
        </div>
        
        <div class="screening">
          <h2>The Apostle (1997)</h2>
          <img src="/images/2023spring/the-apostle-1997.jpg" alt="The Apostle (1997) still">
          ...
          <h2>7:00PM Tuesday, November 28th&middot</h2>
        </div>
