    ...
    <main>
      ...
      <div class="screenings-list">
        ...
        <div class="text-section">
          <h1>THURSDAY II: Myths, Legends, and Folk Tales: A Brief History of Animation</h1>
          <h3>Programmed by Solana Adedokun</h3>
          
          <p>
          Emerging in the late 19th and early 20th century, live-action and animated films share an intertwined history of development and growth that have transformed the world’s entertainment industry forever. Despite animation’s groundbreaking power, it is often underappreciated and relegated as a medium solely for children’s entertainment. This series exists not only to break that harsh stigma, but to cultivate the audience’s appreciation and interest in this challenging, unforgiving, yet utterly rewarding medium.</p>  
           
          <p>Each fantasy-adventure film that will be shown epitomizes the very best of animation in its respective time period, demonstrating not only the strength of animation as a serious storytelling method, but also as an artform unto itself. Whether it's the method of animation the filmmakers choose when bringing a story to life, or the way each technique lends a kind of character to the film that live-action cannot, audience members are sure to find something special in each movie.</p>
        </div>
        ...
        <div class="screening">
          ...
          <p>Set in Ireland in 1650, <i>Wolfwalkers</i> follows young Robyn Goodfellowe, who has moved to the town of Kilkenny with her dad at the request of the Lord Protector to kill the last remaining wolf pack. Outside the city walls, Robyn discovers the remaining wolves and meets Mebh the Wolfwalker, a girl who has the ability to turn into a wolf at night. While forging new friendships, Robyn has to decide whether to remain a hunter, or to help Mebh’s wolfpack.</p>
          <p><b>Tickets can be bought <u><a href="https://tickets.uchicago.edu/Online/seatSelect.asp?createBO::WSmap=1&BOparam::WSmap::loadBestAvailable::performance_ids=51DD4E18-0860-41E8-A292-EF8EE8E9766D" target="_blank">here</a></u>.</b></p>
        </div>
