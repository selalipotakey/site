...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <main>
      ...
      <div style="background: url('/images/2024winter/doc_gif_2.gif') no-repeat top center fixed; width: 99vw; height: 100vw; bottom: 0; object-fit: cover;">
        <h1 style="display: flex; justify-content: center; font-size: 20vw; color: white; margin: 0 auto 0 auto;">WINTER 2024</h1>
      </div>
