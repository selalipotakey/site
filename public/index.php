...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <main>
      ...
      <!-- Heading -->
      <div style="background: url('/images/2024winter/home-page.GIF') no-repeat top center fixed; margin: auto; height: 100vw; bottom: 0; object-fit: cover;">
      ...
      <div class="home-list">
        ...
        <div class="cards">
          <div id="card">
            ...
            <h3 class="card-h3">
              <a href="https://tickets.uchicago.edu/Online/seatSelect.asp?createBO::WSmap=1&BOparam::WSmap::loadBestAvailable::performance_ids=26BD3039-8256-4F98-84B3-0A3FC1BA2330" target="_blank"><u>7:00PM</u></a> &middot; 
          ...
          <div id="card">
            ...
            <h3 class="card-h3">
              <a href="https://tickets.uchicago.edu/Online/seatSelect.asp?createBO::WSmap=1&BOparam::WSmap::loadBestAvailable::performance_ids=4FF302CB-47B7-4037-8AFA-FD3DC6719704" target="_blank"><u>7:00PM</u></a> &middot; 
              4:00PM</h3>
          </div>
          <div id="card">
          ...
          <div id="card">
            ...
            <h3 class="card-h3">
              <a href="https://tickets.uchicago.edu/Online/seatSelect.asp?createBO::WSmap=1&BOparam::WSmap::loadBestAvailable::performance_ids=5E97468E-F075-4141-BF6E-28A28D5FAF8F" target="_blank"><u>7:00PM</u></a> &middot;
