    ...
    <main>
      ...
      <div class="screenings-list">
        ...
        <div class="text-section">
          <h1>SATURDAY: Top Doc: Maverdock—New Releases</h1>
        </div>
        ...
        <div class="screening">
            ...
            <p>Christos Nikou’s acclaimed debut feature, which he co-wrote, co-produced, and directed prior to COVID-19, takes place amid a different kind of pandemic: all around the world, people are randomly falling prey to amnesia. The therapy prescribed to the victims is to engage in stereotypical ‘life experiences’ and document these on Polaroids. This surreal premise, infused with deadpan humor, belies the meditation on loss that lies at the heart of the film.</p>
            <p><b>Tickets can be bought <u><a href="https://tickets.uchicago.edu/Online/seatSelect.asp?createBO::WSmap=1&BOparam::WSmap::loadBestAvailable::performance_ids=E9006AD2-F94F-49C0-B966-449BB201C252" target="_blank">here</a></u>.</b></p>
        </div>
        ...
        <div class="screening">
            ...
            <p>Join us at Doc for the <b>US premiere</b> of <i>Autoerótica</i>! <i>Autoerótica</i> tells the story of Bruna, a teenage girl exploring her sexuality in modern-day Peru, and weaves the cringiest, true-to-life details of adolescence with quietly angry, biting social commentary. A tale of female friendship and the struggle for reproductive justice, Andrea Hoyos' directorial debut is a fiery work that marks the beginning of a new voice in contemporary Latin American cinema.</p>
            <p><b>Tickets can be bought <u><a href="https://tickets.uchicago.edu/Online/seatSelect.asp?createBO::WSmap=1&BOparam::WSmap::loadBestAvailable::performance_ids=058A6043-62F2-4893-A0F5-AA4C5039BC0A" target="_blank">here</a></u>.</b></p>
        </div>
